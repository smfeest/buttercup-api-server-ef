...
/// <summary>
/// Defines the contract of the query provider for <see cref="PasswordAuthenticationService" />.
/// </summary>
public interface IPasswordAuthenticationServiceQueries
{
    /// <summary>
    ...
    /// <param name="currentHash">The current password hash.</param>
